...
<div class="core-form">
 ...
 <div class="col-md-3">
    ...
    <div class="form-group" align="right">
        <div class="col-md-12">    
  <!-- <center>       -->
    <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-primary btn-round btn-block' : 'btn btn-primary btn-round btn-block']) ?>
    <!-- </center> -->
